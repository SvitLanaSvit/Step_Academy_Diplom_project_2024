...
namespace Diplom_project_2024.Migrations
{
    ...
    [Migration("20240325134658_Add-Comments-FavoriteHouses")]
    partial class AddCommentsFavoriteHouses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BedInfoHouse", b =>
                {
                    ...
                    b.HasKey("BedsId", "HousesId");

                    b.HasIndex("HousesId");

                    b.ToTable("BedInfoHouse");
                });
            ...
            modelBuilder.Entity("Diplom_project_2024.Data.BedInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Diplom_project_2024.Data.BedType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BedInfoHouse", b =>
                {
                    b.HasOne("Diplom_project_2024.Data.BedInfo", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Diplom_project_2024.Data.BedInfo", b =>
                {
                    b.HasOne("Diplom_project_2024.Data.BedType", "BedType")
                        .WithMany()
